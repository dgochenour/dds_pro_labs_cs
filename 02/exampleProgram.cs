...
/// <summary>
/// Runs MyTypePublisher or MyTypeSubscriber.
/// </summary>
public static class MyTypeProgram
{
    /// <summary>
    ...
    public static void Main(string[] args)
    {
        ...
        if (arguments.Pub)
        {
            Console.WriteLine($"Running MyTypePublisher on domain {arguments.Domain}");
            MyTypePublisher.RunPublisher(arguments.Domain, arguments.SampleCount);
        }
        else
        {
            Console.WriteLine($"Running MyTypeSubscriber on domain {arguments.Domain}");
            MyTypeSubscriber.RunSubscriber(arguments.Domain, arguments.SampleCount);
        }
    }
