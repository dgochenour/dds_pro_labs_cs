...
/// <summary>
/// Example application that subscribes to MyType.
/// </summary>


public static class MyTypeSubscriber
{
    private static int ProcessData(DataReader<MyType> reader)
    {
    ...
    public static void RunSubscriber(int domainId = 0, int sampleCount = int.MaxValue)
    {
        ...
        // LAB #03 - Use constant defined in IDL
        Topic<MyType> topic = participant.CreateTopic<MyType>(position_topic_name.Value);

        // A Subscriber allows an application to create one or more DataReaders
        // Subscriber QoS is configured in USER_QOS_PROFILES.xml
        Subscriber subscriber = participant.CreateSubscriber();

        // This DataReader reads data on Topic "Example MyType".
        ...
        while (samplesRead < sampleCount)
        {
            ...
            Console.WriteLine("MyType subscriber sleeping for 4 sec...");
