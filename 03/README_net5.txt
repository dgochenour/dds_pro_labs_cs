...
which can run a publisher example (examplePublisher.cs)
or a subscriber example (exampleSubscriber.cs).
...
To modify the data being sent: edit the examplePublisher.cs
file where it says
...
Open example.csproj with Visual Studio to edit, compile, debug,
and run the project.
...
2) In exampleProgram.cs remove the code that uses System.CommandLine.
